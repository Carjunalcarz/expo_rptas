...
const dummy_data = (): AssessmentFormData => ({
    ...
    general_description: { kindOfBuilding: 'Residential', structuralType: 'I-A', buildingPermitNo: 'BP-2023-12345', condominiumCCT: 'asasasdasd', completionCertificateDate: '01/15/2023', occupancyCertificateDate: '02/01/2023', dateConstructed: '01/10/2023', dateOccupied: '02/15/2023', buildingAge: '1', numberOfStoreys: '2', floorAreas: [{ id: '1', floorNumber: 'Ground Floor', area: '80' }, { id: '2', floorNumber: 'Second Floor', area: '70' }], totalFloorArea: '150', floorPlanImages: [], },
